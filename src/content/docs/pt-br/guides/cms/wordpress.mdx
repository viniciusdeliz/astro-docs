...
1. **Um projeto Astro** - Se você ainda não tem um projeto Astro, nosso [Guia de Instalação](/en/install/auto/) fará você construir um projeto o quanto antes.
...
A página `src/pages/dinos/[slug].astro` [gera uma página dinamicamente](/en/core-concepts/routing/#dynamic-routes) para cada dinossauro.
...
Para lançar seu site visite o nosso [guia de lançamento](/en/guides/deploy/) e siga as instruções para o seu fornecedor de hospedagem preferido.
